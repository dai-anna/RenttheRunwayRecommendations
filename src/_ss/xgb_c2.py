...
df = pd.read_parquet("../artifacts/cluster_2.parquet")
...
if IWANTTOWAITANOTHER20MINTOTUNETHESEPARAMS:
    logger = JSONLogger(path="../artifacts/logs/c2.json")
    ...
    with open("../artifacts/best_params_c2.pkl", "wb") as f:
        pickle.dump(best_params, f)
else:
    with open("../artifacts/best_params_c2.pkl", "rb") as f:
