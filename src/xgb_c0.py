...
df = pd.read_parquet("../artifacts/cluster_1.parquet")
...
if IWANTTOWAITANOTHER20MINTOTUNETHESEPARAMS:
    logger = JSONLogger(path="../artifacts/logs/c1.json")
    ...
    with open("../artifacts/best_params_c1.pkl", "wb") as f:
        pickle.dump(best_params, f)
else:
    with open("../artifacts/best_params_c1.pkl", "rb") as f:
